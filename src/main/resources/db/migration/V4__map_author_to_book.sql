ALTER TABLE book ADD COLUMN author_id UUID;
...
insert into book (isbn, publisher, book_title, author_id) values ('978-1617294945', 'Simon & Schuster',
       'Spring in Action, 5th Edition',(select id from author where first_name = 'Craig' and last_name = 'Walls') );

insert into book (isbn, publisher, book_title, author_id) values ('978-1617292545', 'Simon & Schuster',
    'Spring Boot in Action, 1st Edition',(select id from author where first_name = 'Craig' and last_name = 'Walls') );

insert into book (isbn, publisher, book_title, author_id) values ('978-1617297571', 'Simon & Schuster',
...
insert into book (isbn, publisher, book_title, author_id) values ('978-0321125217', 'Addison Wesley',
...
insert into book (isbn, publisher, book_title, author_id) values ('978-0134494166', 'Addison Wesley',
